...
const API_URL =
  'https://intervex-ai-final.onrender.com/api/v1';
...
export const authApi = {
  ...
  studentJoin: (data: any) =>
    api.post('/auth/student/join', data),
...
export const sessionApi = {
  ...
  getQuestions: (id: string) =>
    api.get(`/sessions/${id}/questions`),

  getLiveStatus: (id: string) =>
    api.get(`/sessions/${id}/live-status`),
};
...
export const resultsApi = {
  ...
  exportCsv: (sessionId: string) =>
    api.get(`/results/session/${sessionId}/export/csv`, {
      responseType: 'blob',
    }),
